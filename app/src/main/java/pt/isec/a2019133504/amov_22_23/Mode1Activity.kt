...
class Mode1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textView2.text = binding.board.board.linhasValores.toString() + binding.board.board.colunasValores.toString()
...
/*
class BoardView2 (context: Context, attributeSet: AttributeSet) : View(context, attributeSet),GestureDetector.OnGestureListener {
